...
class RVAdapter(private val context: Context, private val listEProducts: ArrayList<EProduct>): RecyclerView.Adapter<RVAdapter.MyViewHolder>() {
    inner class MyViewHolder(view: View):RecyclerView.ViewHolder(view){

        fun initUIElements(id:Int,name:String,price:Int,image:String){
            ...
            itemView.imgAdd.setOnClickListener{
                ...
                val fragmentManager = (itemView.context as FetchEProductsActivity).supportFragmentManager
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.rw_eproduct_row,parent,false) as View
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.initUIElements(listEProducts[position].id,listEProducts[position].name,listEProducts[position].price,listEProducts[position].picture)
